      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-xl font-bold text-gray-900">ML Portfolio</span>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <a href="#experience" className="text-gray-900 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">Experience</a>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#experience" className="block text-gray-900 hover:text-indigo-600 px-3 py-2 rounded-md text-base font-medium">Experience</a>
